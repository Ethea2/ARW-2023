...
const Timer = ({ date, sevenDaysLeft }) => {
    ...
    return (
        <motion.div className="w-full h-screen m-auto flex justify-center items-center"
            ...
            <div className={`flex flex-col gap-20 justify-center items-center w-9/12 ${sevenDaysLeft ? 'lg:drop-shadow-glow_red text-red-700' : 'lg:drop-shadow-glow_green text-emerald-400'}`}>
