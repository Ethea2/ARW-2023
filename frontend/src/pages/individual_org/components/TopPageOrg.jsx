...
const TopPageOrg = () => {
    return (
        <>
            <div className="top-page-org z-10 bg-indigo-500 w-full flex flex-col pt-24 pb-20 px-4 md:px-8 lg:px-48 xl:px-96 justify-center items-center shadow-2xl">
                <div className="carousel w-full py-0.5 lg:py-7">
