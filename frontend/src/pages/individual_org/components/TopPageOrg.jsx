...
const TopPageOrg = () => {
    return (
        ...
        <div className="top-page-org bg-indigo-500 w-full flex flex-col mt-20 justify-center items-center shadow-2xl">
