...
const VSContainer = ({ team1, team2 }) => {
    return (
        <div className="w-full md:w-[80%] flex justify-between items-center font-monda text-white my-[10px]">
            <h3 className="text-sm bg-black/30 p-2 rounded-lg border-2 border-[#FFD524]/80">
                {team1.org}
            </h3>
